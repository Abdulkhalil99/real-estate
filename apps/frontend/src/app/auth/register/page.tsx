      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-12"
        ...
        <div>
          <h2 className="text-4xl font-bold text-white mb-4 leading-tight">
            Join thousands of<br />agents & owners
          </h2>
          <p style={{ color: '#85929e' }} className="text-lg leading-relaxed">
            Create your free account and start listing properties in minutes. No credit card required.
          </p>
          <div className="space-y-3 mt-8">
            {['Free to list properties', 'Reach thousands of buyers', 'Manage inquiries easily', 'Professional agent profile'].map((f) => (
              <div key={f} className="flex items-center gap-3">
                <div className="w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0" style={{ background: '#3498db' }}>
                  <svg className="w-3 h-3 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                  </svg>
                </div>
                <span style={{ color: '#aab7b8' }} className="text-sm">{f}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 overflow-y-auto">
        <div className="w-full max-w-md py-8">
          ...
          <div className="card p-8">
            <h1 className="text-2xl font-bold mb-1" style={{ color: '#2c3e50' }}>Create account</h1>
            <p className="text-sm mb-6" style={{ color: '#7f8c8d' }}>Fill in your details to get started</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <div className="relative">
                    <User className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4" style={{ color: '#95a5a6' }} />
                    <input type="text" className={'input pl-10 ' + (errors.firstName ? 'input-error' : '')}
                      placeholder="John"
                ...
                <div>
                  ...
                  <div className="relative">
                    <User className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4" style={{ color: '#95a5a6' }} />
                    <input type="text" className={'input pl-10 ' + (errors.lastName ? 'input-error' : '')}
                      placeholder="Doe"
                      value={form.lastName}
              ...
              <div>
                ...
                <div className="relative">
                  <Phone className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4" style={{ color: '#95a5a6' }} />
            ...
            <div className="mt-4 pt-4 text-center text-sm" style={{ borderTop: '1px solid #f0f3f6', color: '#7f8c8d' }}>
              ...
              <Link href="/auth/login" className="font-semibold hover:underline" style={{ color: '#3498db' }}>
                Sign in
              </Link>
            </div>
          </div>
